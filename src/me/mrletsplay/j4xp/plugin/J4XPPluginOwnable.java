 ...
 * Before an object can be destroyed automatically, it needs to be added to a plugin using {@link XPPlugin#addOwnedObject(PluginOwnable)}. This should normally be done inside the constructor of the object's respective class.<br>
