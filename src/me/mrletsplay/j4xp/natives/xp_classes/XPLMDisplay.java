...
import me.mrletsplay.j4xp.natives.classes.XPLMHotKeyInfo;
...
import me.mrletsplay.j4xp.natives.enums.XPLMWindowPositioningMode;
...
//	}
	...
	public static XPLMHotKeyID registerHotKey(char virtualKey, EnumFlagCompound<XPLMKeyFlag> flags, String description, XPLMHotKey callback, Object refcon) {
		return J4XP.getHotKeyIDs().getOrCreate((long) XPNativeInterface.executeFunction(NativeFunction.XPLMDISPLAY_REGISTER_HOT_KEY, virtualKey, flags.getCompound(), description),
